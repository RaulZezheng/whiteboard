...
void SendTimer::createWhiteboardRequest(int userID)
{
    sendJsonObject["version"] = 1;
    sendJsonObject["packet_type"] = 1;
    sendJsonObject["session_id"] = 0;
    sendJsonObject["user_id"] = userID;
    QJsonObject action;
    action["user_id"] = userID;
    sendJsonObject["action"] = action;
    sendJson();
}

void SendTimer::registerRequest(int userID, QString username, QString password_hash)
{
    sendJsonObject["version"] = 1;
    sendJsonObject["packet_type"] = 0;
    sendJsonObject["session_id"] = 0;
    sendJsonObject["user_id"] = userID;
    QJsonObject action;
    action["username"] = username;
    action["password_hash"] = password_hash;
    sendJsonObject["action"] = action;
    sendJson();
}

void SendTimer::loginRequest(int userID, QString username, QString password_hash, QString token)
{
    sendJsonObject["version"] = 1;
    sendJsonObject["packet_type"] = 0;
    sendJsonObject["session_id"] = 0;
...
void SendTimer::createSessionRequest(int userID, int whiteboardID)
{
    sendJsonObject["version"] = 1;
    sendJsonObject["packet_type"] = 2;
    sendJsonObject["session_id"] = 0;
    sendJsonObject["user_id"] = userID;
    QJsonObject action;
    action["user_id"] = userID;
    action["whiteboard_id"] = whiteboardID;
    sendJsonObject["action"] = action;
    sendJson();
}

void SendTimer::joinSessionRequest(int userID, int sessionID)
{
    sendJsonObject["version"] = 1;
    sendJsonObject["packet_type"] = 0;
    sendJsonObject["session_id"] = sessionID;
    sendJsonObject["user_id"] = userID;
    QJsonObject action;
    action["user_id"] = userID;
...
void SendTimer::quitSessionRequest(int userID, int sessionID)
{
    sendJsonObject["version"] = 1;
    sendJsonObject["packet_type"] = 3;
    sendJsonObject["session_id"] = sessionID;
    sendJsonObject["user_id"] = userID;
    QJsonObject action;
    action["user_id"] = userID;
...
//void SendTimer::addElementRequest(int userID, int sessionID)
//{
//    sendJsonObject["version"] = 1;
//    sendJsonObject["packet_type"] = 0;
//    sendJsonObject["session_id"] = sessionID;

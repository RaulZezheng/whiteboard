...
//    void sendMsg(QString msg);
    ...
    void createWhiteboardRequest(int userID);
    void registerRequest(int userID, QString username, QString password_hash);
    void loginRequest(int userID, QString username, QString password_hash, QString token);
    void createSessionRequest(int userID, int whiteboardID);
    void joinSessionRequest(int userID, int sessionID);
    void quitSessionRequest(int userID, int sessionID);
